...
?>
    <div class="thumbnail col-md-8 col-md-offset-2">
        ...
        <br>
        <form class="form" action="userdelete-handler.php" method="post">
            <?php
            ...
            <div class="form-group col-md-8 col-md-offset-2">
                ...
                <div class="col-md-10">
                    <input readonly="readonly" type="text" class="form-control" id="name" name="account" placeholder="Enter email" value="<?=$user['account']?>"></input>
                </div>
            <br><br>
                <label class="col-md-2" for="name">姓名</label>
                <div class="col-md-10">
                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter email" value="<?=$user['name']?>"></input>
                </div>
            <br><br>
            ...
            <button type="submit" class="btn btn-primary col-md-3 col-md-offset-7">确认删除</button>
            <?php
            }
            ?>
        </form>
